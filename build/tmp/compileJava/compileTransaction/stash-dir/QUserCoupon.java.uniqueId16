...
public class QUserCoupon extends EntityPathBase<UserCoupon> {
    ...
    private static final long serialVersionUID = 702075087L;
    ...
    public final EnumPath<kr.hhplus.be.server.enums.CouponStatus> status = createEnum("status", kr.hhplus.be.server.enums.CouponStatus.class);
