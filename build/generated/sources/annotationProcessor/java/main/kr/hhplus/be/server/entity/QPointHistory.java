...
public class QPointHistory extends EntityPathBase<PointHistory> {
    ...
    private static final long serialVersionUID = -609623454L;
    ...
    public final EnumPath<kr.hhplus.be.server.enums.PointStatus> status = createEnum("status", kr.hhplus.be.server.enums.PointStatus.class);
